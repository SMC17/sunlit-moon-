...
export default function AboutPage() {
  return (
    <article className="pb-28">
      <header className="masthead-wash border-b border-ink/10">
        <div className="mx-auto max-w-page px-5 py-20 md:px-8 md:py-28">
          <p className="label">{site.tagline}</p>
          <h1 className="mt-5 max-w-5xl font-display text-5xl leading-[0.9] tracking-[-0.035em] text-pretty md:text-[5.4rem]">
            A public ledger for a city that faces the water.
          </h1>
          <p className="mt-10 max-w-2xl font-body text-xl leading-relaxed text-ink-muted md:text-[1.4rem]">
      ...
      <Reveal>
        <div className="mx-auto grid max-w-page gap-16 px-5 py-20 md:grid-cols-12 md:px-8">
          <section className="md:col-span-7">
            <h2 className="font-display text-4xl tracking-tight">Why Evanston first</h2>
          ...
          <aside className="border-t border-ink/15 pt-8 md:col-span-4 md:col-start-9 md:border-l md:border-t-0 md:pl-10 md:pt-0">
            <p className="label">Forthcoming editions</p>
            <ul className="mt-6 space-y-5">
              {site.comingSoon.map((place) => (
                <li key={place} className="border-b border-ink/10 pb-5 font-display text-3xl tracking-tight">
                  {place}
      ...
      <section className="mx-auto max-w-page px-5 md:px-8">
        <div className="grid gap-10 border-y border-ink/15 py-14 md:grid-cols-3">
          {[
            {
              title: "Stories",
        ...
        <p className="mt-12 max-w-xl text-ink-muted">
          Desk: {site.email}. The evening edition, when it exists, lives on the{" "}
          <Link href="/newsletter" className="link-quiet text-ink">
            newsletter
          </Link>{" "}
          page.
        </p>
